...
// DB discovery, sql.js bootstrap, and chunked/locked DB reads now live in
// ``./stateDb``. They are re-exported above so external callers
// (extension.ts, tests, the deprecated reproduce-token-lookup.cjs probe)
// keep working without touching this file's import surface.
